...
return  array(
    ...
    'COOKIE_PREFIX'         =>  'cssd',      // Cookie前缀 避免冲突
    ...
    'SESSION_OPTIONS'       =>  array('expire'=>0), // session 配置数组 支持type name id path expire domain 等参数
    'SESSION_TYPE'          =>  '', // session hander类型 默认无需设置 除非扩展了session hander驱动
    'SESSION_PREFIX'        =>  'cssd', // session 前缀
